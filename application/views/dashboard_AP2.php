            ...
            <div class="row">
             ...
             <div class="row">
                ...
                <div class="col-md-offset-11" style="padding-bottom: 10px">
                    <a href="<?php echo base_url()."index.php/pagecontrol/formAP2"?>"><button type="button" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i>  ADD</button></a>
                </div>
                     <div class="panel panel-yellow">
                        ...
                        <div class="panel-body">
                            ...
                            <table id="dtHorizontalExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                <thead>
                                    <tr >
                                        <th>Instruction Memorium Order</th>
                                        <th>Instruction Memorium Order (back)</th>
                                        <th>Name CUSTOMER</th>
                                        <th>Invoice CUSTOMER</th>
                                        <th>Invoice AGEN</th>
                                        <th>Payment AGEN</th>
                                        <th>Invoice GENSET</th>
                                        <th>Payment GENSET</th>
                                        <th>Invoice SHIP</th>
                                        <th>Payment SHIP</th>
                                        <th></th>
                                    </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        <td style="color: red"><?php echo $ap->IMO ?></td>
                                        <td><?php echo $ap->IMO_v2 ?></td>
                                        <td><?php echo $ap->name_cust ?></td>
                                        <td><?php echo $ap->inv_cust ?></td>
                                        ...
                                        <td>
                                        <a href="editAP2/<?php echo $ap->IMO_v2; ?>"><button type="button" class="btn btn-info btn-circle"><i class="fa fa-edit"></i></button> </a>  
                                        </td>
                                    </tr>  
                                    <?php } ?>
