                    ...
                    <div class="panel panel-green">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-offset-2">
                                <div class="col-lg-8">
                                    <form role="form" method="post" action="<?php echo base_url()."index.php/pagecontrol/insertAR"; ?>">
                                        ...
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input class="form-control" placeholder="Enter Name" name="name_cust">
                                        </div>
                                        <div class="form-group">
                                            <label>Invoice</label>
                                            <input class="form-control" placeholder="Enter Invoice" name="inv_cust">
                                        </div>
