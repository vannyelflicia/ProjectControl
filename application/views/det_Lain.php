                                ...
                                <div class="col-lg-8">
                                    ...
                                    <?php foreach ($detLain as $r) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label><?php echo $r->inv_lain ?></label>
                                        </div>
                                        <div class="form-group">
                                            <label>Payment Date Lain </label>
                                            <label><?php echo $r->date_lain ?></label>
                                        </div>
                    ...
                    <?php
                        ...
                        echo "<br> <br>";
                            ...
                            ?>
                                ...
                                <p id="value" ></p>
                                <form role="form" method="post" action="<?php echo base_url()."index.php/pagecontrol/simpandetLain"; ?>">
