                            ...
                            <div class="col-md-offset-2">
                                <div class="col-lg-8">
                                    ...
                                    <?php foreach ($detPlugap as $r) { ?>
                                        ...
                                        <div class="form-group">
                                            <label>Invoice </label>
                                            <label><?php echo $r ->inv_plug ?></label>
                                        </div>
                                        <div class="form-group">
                                            <label>Payment Date </label>
                                            <label><?php echo $r ->date_plug ?></label>
                                        </div>
                    ...
                    <?php
                        ...
                        echo "<br> <br>";
                            ...
                            ?>
                                ...
                                <p id="value" ></p>
                                <form role="form" method="post" action="<?php echo base_url()."index.php/pagecontrol/simpandetPlugap"; ?>">
