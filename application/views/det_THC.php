                                ...
                                <div class="col-lg-8">
                                    ...
                                    <?php foreach ($detTHC as $r) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label><?php echo $r->inv_thc ?></label>
                                        </div>
                                        <div class="form-group">
                                            <label>Payment Date THC : </label>
                                            <label><?php echo $r->date_thc ?></label>
                                        </div>
                    ...
                    <?php
                        ...
                        echo "<br> <br>";
                            ...
                            ?>
                                ...
                                <p id="value" ></p>
                                <form role="form" method="post" action="<?php echo base_url()."index.php/pagecontrol/simpandetTHC"; ?>">
