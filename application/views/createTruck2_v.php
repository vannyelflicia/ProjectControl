                    ...
                    <div class="panel panel-red">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-offset-2">
                                <div class="col-lg-8">
                                    <form role="form" method="post" action="<?php echo base_url()."index.php/pagecontrol/insertTruck2"; ?>">
                                   		 <div class="form-group">
                                            <label>Instruction Memorium Order (IMO)</label><br>
                                            <select class="form-control" required name="IMO_v2" required>
                                            <?php foreach ($noIMO as $no) { ?>
                                            <option><?php echo $no ->IMO_v2 ?></option>
                                            <?php } ?>
                                            </select> 
                                        </div>
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input class="form-control" placeholder="Enter Name" name="name_truck" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Invoice</label>
                                            <input class="form-control" placeholder="Enter Invoice" name="inv_truck">
                                        </div>
                                        <div class="form-group">
                                            <label>Payment</label>
                                            <input class="form-control" placeholder="Enter Payment" name="pay_truck">
                                        </div>
