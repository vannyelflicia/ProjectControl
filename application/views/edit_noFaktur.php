...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <h1 class="page-header"><center>PAJAK FORM </center></h1>
                <div  style="padding-bottom: 10px">
                    <a href="<?php echo base_url()."index.php/pagecontrol/dashPajak"?>"><button type="button" class="btn btn-success"><i class="glyphicon glyphicon-arrow-left  "></i>  BACK</button></a>
                </div>
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-offset-2">
                                <div class="col-lg-8">
                                    <form role="form" method="post" action="<?php echo base_url()."index.php/pagecontrol/simpannoFaktur"; ?>">
                                    <?php foreach ($editpajak as $r) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="<?php echo $r ->no_faktur ?>" name="no_faktur">
                                        </div>
                                    <?php } ?>
