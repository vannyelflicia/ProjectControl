                            ...
                            <div class="col-md-offset-2">
                                <div class="col-lg-8">
                                    ...
                                    <?php foreach ($editap as $n) { ?>
                                         ...
                                         <input type="hidden" class="form-control" name="IMO" value="<?php echo $n->IMO ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="<?php echo $n->rent_genset ?>" name="rent_genset">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="<?php echo $n->inv_thc ?>" name="inv_thc">
                                        </div>
                                        <div class="form-group">
                                            <label>Payment THC</label>
                                            <input class="form-control" value="<?php echo $n->pay_thc ?>" name="pay_thc">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="<?php echo $n->inv_handl ?>" name="inv_handl">
                                        </div>
                                        <div class="form-group">
                                            <label>Payment Handling</label>
                                            <input class="form-control" value="<?php echo $n->pay_handl ?>" name="pay_handl">
                                        </div>
                                        <div class="form-group">
                                            <label>Payment Date Handling</label>
                                            <input type="date" class="form-control" value="<?php echo $n->date_handl ?>" name="date_handl">
                                        </div>
                                        <div class="form-group">
                                            <label>Invoice Plug</label>
                                            <input class="form-control" value="<?php echo $n->inv_plug ?>" name="inv_plug">
                                        </div>
                                        <div class="form-group">
                                            <label>Payment Plug</label>
                                            <input class="form-control" value="<?php echo $n->pay_plug ?>" name="pay_plug">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="<?php echo $n->inv_lain ?>" name="inv_lain">
                                        </div>
                                        <div class="form-group">
                                            <label>Payment Lain</label>
                                            <input class="form-control" value="<?php echo $n->pay_lain ?>" name="pay_lain">
                                        </div>
                                        <div class="form-group">
