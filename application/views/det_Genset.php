                                ...
                                <div class="col-lg-8">
                                    ...
                                    <?php foreach ($detGenset as $r) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label><?php echo $r->rent_genset ?></label>
                                        </div>
                                        <div class="form-group">
                                            <label>Invoice Genset : </label>
                                            <label><?php echo $r->inv_genset ?></label>
                                        </div>
                                        <div class="form-group">
                                            <label>Payment Date Genset : </label>
                                            <label><?php echo $r->date_genset ?></label>
                                        </div>
                    ...
                    <?php
                        ...
                        echo "<br> <br>";
                            ...
                            ?>
                                ...
                                <p id="value" ></p>
                                <form role="form" method="post" action="<?php echo base_url()."index.php/pagecontrol/simpandetGenset"; ?>">
