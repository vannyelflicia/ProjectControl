                                ...
                                <div class="col-lg-8">
                                    ...
                                    <?php foreach ($detAgen as $r) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label><?php echo $r->name_ag ?></label>
                                        </div>
                                        <div class="form-group">
                                            <label>Invoice Agen : </label>
                                            <label><?php echo $r->inv_ag ?></label>
                                        </div>
                    ...
                    <?php
                        ...
                        echo "<br> <br>";
                            ...
                            ?>
                                ...
                                <p id="value" ></p>
                                <form role="form" method="post" action="<?php echo base_url()."index.php/pagecontrol/simpandetAgen"; ?>">
