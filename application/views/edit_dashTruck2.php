        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <div  style="padding-bottom: 10px">
                    <a href="<?php echo base_url()."index.php/pagecontrol/dashTruck2"?>"><button type="button" class="btn btn-success"><i class="glyphicon glyphicon-arrow-left  "></i>  BACK</button></a>
                </div>
                    <div class="panel panel-red">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-offset-2">
                                <div class="col-lg-8">
                                    <form role="form" method="post" action="<?php echo base_url()."index.php/pagecontrol/simpanTruck2"; ?>">
                                    <?php foreach ($edittruck as $c) { ?>
                                   		 <div class="form-group">
                                         <input type="hidden" class="form-control" value="<?php echo $c->IMO_v2 ?>" name="IMO_v2">
                                            <label>Instruction Memorium Order</label><br>
                                            <label><?php echo $c->IMO_v2 ?></label>
                                        </div>
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input class="form-control" value="<?php echo $c->name_truck ?>" name="name_truck">
                                        </div>
                                        <div class="form-group">
                                            <label>Invoice</label>
                                            <input class="form-control" type="text" value="<?php echo $c->inv_truck ?>" name="inv_truck">
                                        </div>
                                        <div class="form-group">
                                            <label>Payment</label>
                                            <input class="form-control" value="<?php echo $c->pay_truck ?>" name="pay_truck">
                                        </div>
