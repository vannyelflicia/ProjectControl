                            ...
                            <table id="dtHorizontalExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $k->pesanan ?></td>
                                        <td><?php echo $k->no_pol ?></td>
                                        
                                        <td><?php echo $k->jam ?></td>
                                        <td><?php echo $k->muatan ?></td>
                                        <td><?php echo $k->ukuran ?></td>
                                        <td><?php echo $k->b_jajan ?></td>
                                        <td><?php echo $k->b_kom ?></td>
                                        <td><?php echo $k->b_kawal ?></td>
                                        <td><?php echo $k->b_lain ?></td>
                                        <td>
                                        <a href="editTruck/<?php echo $k->IMO; ?>"><button type="button" class="btn btn-info btn-circle"><i class="fa fa-edit"></i></button> </a>  
                                        <a href="exportTruck/<?php echo $k->IMO; ?>"><button type="button" class="btn btn-success btn-circle"><i class="fa fa-download"></i></button> </a> 
                                        </td>
                                    </tr>  
                                    <?php } ?>
